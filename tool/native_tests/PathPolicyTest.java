...
public class PathPolicyTest {
    public static void main(String[] args) throws Exception {
        String[] valid = {"pcdrdata.sqlite3", "Inspections/pcdrdata.sqlite3", " Folder\\db.sqlite "};
        String[] expected = {"pcdrdata.sqlite3", "Inspections/pcdrdata.sqlite3", "Folder/db.sqlite"};
